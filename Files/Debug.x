                           ...
                           maxDepth:(NSInteger)maxDepth
{
    ...
    if (depth < maxDepth) {
        ...
        /*
         * نستخدم نسخة من subviews حتى لا نعتمد على
         * أي block recursive، وبالتالي لا يوجد
         * retain cycle مع ARC.
         */
 ...
 * مهم:
 *
 * هذه الدالة هي الإصلاح الأساسي للخطأ:
 *
 * capturing 'collect' strongly in this block is likely
 * to lead to a retain cycle
 *
 * لا يوجد هنا recursive block.
 * الاستدعاء recursive يتم عن طريق method نفسها.
 */
...
- (UIView *)findBestAccessibilityViewFromView:(UIView *)view
{
    ...
    /*
     * 1. إذا كان العنصر الذي أصابته اللمسة نفسه
     * Accessibility Element فهو الاختيار الأول.
     */
    if (view.isAccessibilityElement) {
        return view;
    }
    ...
    /*
     * 2. ابحث للأعلى عن أقرب View لديه بيانات
     * Accessibility.
     */
    UIView *current =
        view;
